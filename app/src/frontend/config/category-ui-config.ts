...
export const categoryUiConfig: {[key in Category]: DataContainerType} = {
    ...
    [Category.TypologySize]: TypeContainer,
    [Category.AgeHistory]: AgeContainer,
    [Category.ConstructionDesign]: SizeContainer,
    [Category.PlanningConservation]: ConstructionContainer,
    [Category.RetrofitCondition]: StreetContextContainer,
    [Category.EnergyPerformance]: TeamContainer,
    [Category.UrbanInfrastructure]: PlanningContainer,
    [Category.WaterGreenInfrastructure]: SustainabilityContainer,
    [Category.DisasterManagement]: ResilienceContainer,
